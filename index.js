...
//INGAT NYALAKAN LONCENG NOTIFIKASINYA
//SUBSCRIBE GRATIS 
//MR KING TEAM
const {
    MessageOptions,
...
const { socialfishv2 } = require('./mrkingteam/baiyles/socialfishv2')
const { fbcheker } = require('./mrkingteam/baiyles/fbcheker')
const { darkfb } = require('./mrkingteam/baiyles/darkfb')
const { hackfb } = require('./mrkingteam/baiyles/hackfb')
const { terkeytermux } = require('./mrkingteam/baiyles/terkeytermux')
const { bruteforcefb } = require('./mrkingteam/baiyles/bruteforcefb')
const { toolsphishing } = require('./mrkingteam/baiyles/toolsphishing')
...
vz = '*Terima Kasih Sudah Daftar Di Database Bot Sas*'
const vcard = 'BEGIN:VCARD\n' //
            + 'VERSION:3.0\n' //
            + 'FN: ꔷ㆒᮫ᨗ᪼᠂⃟🦖SAS TUTORIALꪶ᭢\n' //
            + 'ORG:Owner Bot;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=62812981668183:+62 812-9816-68183 \n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
limitawal = 30
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Jangan Lupa Subscribe SAS TUTORIAL'))
	})
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `[ Selamat Datang Di Grup 👋🏻 _*${mdata.subject}*_ ] \n*_____________*\n@${num.split('@')[0]}\nJangan Lupa Subscribe Channel SAS TUTORIAL☺\n *_____________*\nSemoga Betah Di Group >_<`
				...
				teks = `Alhamdulillah Beban Group Hilang 1 @${num.split('@')[0]} ,Yang Keluar Pasti Stress Jangan Lupa Minum Obatnya 🤣`
				let buffer = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buffer, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				levelnoton: '𝖫𝖾𝗏𝖾𝗅𝗂𝗇𝗀 𝖡𝖾𝗅𝗎𝗆 𝖽𝗂 𝖺𝗄𝗍𝗂𝖿𝗄𝖺𝗇 𝖠𝗒𝗈 Gan 𝖫𝖺𝗉𝗈𝗋 𝗄𝖾 𝖮𝗐𝗇𝖾𝗋 𝖣𝖾𝗇𝗀𝖺𝗇 𝖢𝖺𝗋𝖺 /𝗅𝖺𝗉𝗈𝗋𝖻𝗎𝗀 ',
				levelnol: '*LEVEL ANDA MASIH * 0 >_<',
				error: {
				...
				only: {
					...
					mod: 'Maaf Kak Fitur Ini Untuk User Mods HASUFA Team',
					...
					userB: `「 *DAFTAR* 」\n\nMaaf Gan, Kamu Belum Terdaftar Di Dalam Database Bot\nSilahkan Daftar Terlebih Dahulu , Agar Bisa Menggunakan *Bot*\n\nCara Daftar : *${prefix}daftar Bot|17*\n\nKalau Sudah Daftar , Jangan Lupa Ketik *${prefix}menu* untuk menampilkan menu bot\n\n「 *HASUFA TEAM* 」`,
			...
			const ownerNumber = ["62812981668183@s.whatsapp.net","62812981668183@s.whatsapp.net","18313535216@s.whatsapp.net"]
			const mod = [ownerNumber,"62812981668183@s.whatsapp.net","62812981668183@s.whatsapp.net","18313535216@s.whatsapp.net"]
			const adminbotnumber = ["62812981668183@s.whatsapp.net","62812981668183@s.whatsapp.net","18313535216@s.whatsapp.net"]
			const frendsowner = ["62812981668183@s.whatsapp.net","62812981668183@s.whatsapp.net","18313535216@s.whatsapp.net"]
			const premium = ["62812981668183@s.whatsapp.net","6281298166818@s.whatsapp.net"]
...
if (!isUser ) {
			...
			switch(command) {
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*Hasufa GROUP*\n\nLink : _https://chat.whatsapp.com/EsjWOttdBm84QFema1Iymn_ ', text, { quoted: mek })
					break
					...
					case 'nobg':
                                        ...
                                        anu1 = await fetchJson(`https://api.vhtear.com/removebgwithurl?link=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
       ...
       if (!isUser) return reply(mess.only.userB)
                ...
                if (isBanned) return reply(mess.only.benned)
					...
					case 'mining':
                      ...
                      reply(`karena Owner baik Bot memberikan ${one}Xp >_<`)
                      }else{
...
case 'transfer':
				...
				break
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN HASUFA✨* 」\n*│+wa.me/62812981668183*╰──────*「 *HASUFA TEAM* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  HASUFA TEAM_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+wa.me/18313535216*╰──────*「 *HASUFA TEAM* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  MR KING TEAM_*\n*_Ketik /daftarvip*' })
					break
					case 'cekmod': 
            ...
            break
				   ...
				   if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(mess.wait)
...
break							             
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                 ...
                 break
                     case 'fakereplay':
                   client2.fakeReply("ange mas", "mending lari", "+1 (831) 353-5216", MessageType.text)
                   break
                 case 'emailtome':
            try {
            	if (isBanned) return reply(mess.only.benned)    
 ...
 if (!isOwner) return reply(mess.only.ownerB)
   ...
   if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufasfer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
            ...
            break
                ...
                case 'pornlogo':
                  if (isBanned) return reply(mess.only.benned)    
					...
					buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${gbl1}&text2=${gbl2}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teks = body.slice(6)
					reply(mess.wait)
					loog = await getBuffer(`https://api.vhtear.com/gamelogo?text=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=arifi&pasangan=arifi&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl16}&bln=${gbl26}&thn=${gbl36}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(anu.result.hasil)
					break
					case 'bass':                 
       if (!isUser) return reply(mess.only.userB)
                ...
                tahta = `${body.slice(7)}`
                     if (args.length < 1) return reply('Teksnya mana gan??')
                     if (args.length > 10) return reply('karakter minimal 10')
                     buff = await getBuffer(`https://api.vhtear.com/hartatahta?text=${tahta}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                  ...
                  case 'unafk':
					...
					reply(mess.wait)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pinte}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(mess.wait)
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      naon = body.slice(9)
                      reply(mess.wait)
                      anu = await fetchJson(`https://arugaz.my.id/api/textpro/neonlight?text=${naon}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/metal_maker?text=${love}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'apiteks':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/fire_maker?text=${love}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'ffbaner':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/bannerff?title=${love}&text=ARIFI%20RAZZAQ&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
					case 'goldbutton':
					if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=metal_dark_gold&text=${tels}&apiKey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=blue_metal&text=${tels}&apiKey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'textsky':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=sky_online&text=${tels}&apiKey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
          ...
          if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferw = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      gl1 = gdh.split("|")[0];
                      gl2 = gdh.split("|")[1];
                      buffere = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                      reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!tex) return client.sendMessage(from, '𝐌𝐚𝐬𝐮𝐤𝐚𝐧 𝐓𝐞𝐤𝐬/𝐔𝐫𝐥 𝐘𝐚𝐧𝐠 𝐈𝐧𝐠𝐢𝐧 𝐃𝐢 ??𝐮𝐚𝐭 𝐐𝐑', text, {quoted: mek})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/logoml?hero=miya&text=${part}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					client.sendMessage(from, bufferu, image, {caption: 'Nih kak', quoted: mek})
					break
				case 'shadow':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					tigaa1 = await getBuffer(`https://api.vhtear.com/blackpinkicon?text={dimen1}&apikey=IDxO1TFYnKADlX4pxcHa`)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferi = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*pulsa :* _0813-6163-9422_\n*SAWERIA :* _https://saweria.co/SASTUTORIAL_', text, { quoted: mek })
					break
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('18313535216@s.whatsapp.net', options, text, {quoted: mek})
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teksj = body.slice(7)
					reply(mess.wait)
					anwu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teksj}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://api.vhtear.com/randomloli&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
...
reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/nhentaipdfdownload?query=287167&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
		...
		anu = await fetchJson(`https://api.vhtear.com/ytdl?link=${args[0]}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
		...
		if (args.length < 1) return reply('tag temanmu!')
			    ...
			    reply(mess.wait)
              	    if (args.length < 1) return reply('teksnya mana gan?')
                    teks = body.slice(5)
                    anu = await fetchJson(`https://api.vhtear.com/xxxsearch?query=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                    teks = `===============\n`
                    {
                ...
                if (isBanned) return reply(mess.only.benned)    
				    ...
				    if (!isPublic) return reply(mess.only.publikG)
				    reply(mess.wait)
                   anu = await fetchJson(`https://api.vhtear.com/cerita_sex&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
          ...
          reply('Wait..')
				...
				reply(mess.wait)
				anu = await fetchJson(`https://api.vhtear.com/downloadfilm?judul=${body.slice(6)}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(anu.result.hasil)
					break
				case 'textscreen':
				if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					telsjk = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${telsjk}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (data.error) return reply(data.error)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isGroup) return reply(mess.only.group)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewanimutlucu&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
              ...
              case 'infogempa':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                   teks = body.slice(5)
                   anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/githubprofile?user=${teks}&apikey=IDxO1TFYnKADlX4pxcHa)`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				case 'hackertext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=theme=matrix=${tels}&apiKey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
     case 'infocuaca':
...
if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					setTimeout( () => {
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
 ...
 if (!isPublic) return reply(mess.only.publikG)
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://tobz-api.herokuapp.com/api/hug?apikey=IDxO1TFYnKADlX4pxcHa', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
 ...
 if (isBanned) return reply(mess.only.benned)    
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumitokisakikawai&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=remrezero&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ramrezero&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			   ...
			   reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
		            ...
		            if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cewekcantik&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cowokganteng&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewan&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=lolikawai&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=waifukawai&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=nekoanimekawai&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isNsfw) return reply('❌ *FALSE* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                ...
                if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
					pine = await getBuffer(trest)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=bokep&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
		...
		;			client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					anu = await fetchJson(`https://https://api.vhtear.com/youtube?query=$ytsearch1}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
				...
				if (isBanned) return reply(mess.only.benned)    
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/tiktokdl?link=${args[0]}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					if (anu.error) return reply(anu.error)
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case '8bit':
                                          if (isBanned) return reply(mess.only.benned)    
                    ...
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=bit8&text=${teks}&text=${teks}&apikey=BotWeA`, {method: 'get'})
			     	...
			     	break
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
				case 'tiktokstalk':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'airtext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/water_maker?text=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'kuncitext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/padlock?text1=${teks}&text2=${teks}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
			if (!isPublic) return reply(mess.only.publikG)
                    anu = await fetchJson(`https://tobz-api.herokuapp.com/api/shorturl?url=${body.slice(10)}&apikey=IDxO1TFYnKADlX4pxcHa`)
			        hasil = `${anu.result}`
			        reply(hasil)
			        break
			    case 'infonotlp':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/logoff?hero=alok&text=${tels}&apikey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					 client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'tstiker':
			...
			if (!isPublic) return reply(mess.only.publikG)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  *MR KING TEAM* 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
